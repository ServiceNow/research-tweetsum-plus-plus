...
from factsumm.models.convert_to_extractive import tokenize
from factsumm.models.helpers import (
    LabelSmoothingLoss,
    SortishSampler,
...
class AbstractiveSummarizer(pl.LightningModule):
    ...
    def prepare_data(self):
        ...
        for split, features_cache_file in self.tokenized_data_file_paths.items():
            ...
            cache_dir_path = self.hparams.cache_file_path
            if not os.path.exists(cache_dir_path):
                os.makedirs(cache_dir_path)
                logger.info(f"Created cache directory at {cache_dir_path}")
