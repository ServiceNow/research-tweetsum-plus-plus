...
from factsumm.utils import clean_extractive_summaries, clean_abstractive_summaries, concatenate_dialog
...
class RougeEval:
    ...
    def evaluate(self, dataframe):
        ...
        for (
            ...
            #     ]
            # )
            concatenated_extsum_summary = concatenate_dialog(row["extractive_summary"])
    ...
    def evaluate_only_extractive(self, dataframe):
        # initialize variable to accumulate scores of extractive summaries
        (
            total_rouge1_precision_extractive,
            total_rouge1_recall_extractive,
